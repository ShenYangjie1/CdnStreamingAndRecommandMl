...
object ChineseHandle {
  ...
  def stopwordFilter(content: Result): Result = {
    val filter = new StopRecognition();
    filter.insertStopNatures("uj");//过滤词性(助词)
    filter.insertStopNatures("ul");
    filter.insertStopNatures("null");
    val stopwords = new util.ArrayList[String](10)
    util.Collections.addAll(stopwords,
      "一",
      "一.",
      "一一",
      "一下",
