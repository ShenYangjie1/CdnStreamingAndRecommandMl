...
/**
  ...
  */
class IPService (ipArray: Broadcast[Array[IPRegion]], lruCache: Int, synchronized: Boolean){

  private val array = ipArray.value
...
object IPService{
  ...
  def apply(ipArray: Broadcast[Array[IPRegion]], lruCache: Int = 10000, synchronized: Boolean):
